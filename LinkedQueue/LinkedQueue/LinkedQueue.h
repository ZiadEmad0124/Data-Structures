...
public:
    ...
    void dequeue(){
        if(is_linked_queue_empty()){
            cout << "Can't dequeue, cause LinkedQueue is empty" << endl;
        }else{
            node<type>* curr_ptr = front;
    ...
    void is_empty(){
        string s = is_linked_queue_empty() ? "Yes, LinkedQueue is empty" : "No, LinkedQueue isn't empty";
        cout << s << endl;
    }

    void get_front(){
        if(is_linked_queue_empty())
            cout << "Front not found, cause LinkedQueue is empty" << endl;
        else
    ...
    void get_rear(){
        if(is_linked_queue_empty())
            cout << "Rear not found, cause LinkedQueue is empty" << endl;
        else
    ...
    void search(type item) {
        if (is_linked_queue_empty())
            cout << "Can't find " << item << ", cause LinkedQueue is empty" << endl;
    ...
    void clear() {
        if (is_linked_queue_empty()){
            cout << "Can't clear LinkedQueue, cause it is empty" << endl;
        }else {
            while (!is_linked_queue_empty()) {
                dequeue();
            }
        }
    }
    ...
    void display(){
        if(is_linked_queue_empty()){
            cout << "Can't display LinkedQueue, cause it is empty" << endl;
        }else{
